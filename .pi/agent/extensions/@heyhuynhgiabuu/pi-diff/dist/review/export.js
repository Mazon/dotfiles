export function formatReviewMarkdown(diff, options = {}) {
    ...
    lines.push("");
    lines.push("Review the changed files below. Focus on correctness, regressions, security, missing tests, and maintainability. Cite file paths and changed line numbers. Do not comment on unchanged code unless it is necessary to explain a changed-line issue.");
    lines.push("");
