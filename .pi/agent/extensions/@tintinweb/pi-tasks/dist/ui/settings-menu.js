    ...
    await ui.custom((_tui, theme, _kb, done) => {
        const items = [
            ...
            },
            {
                ...
                description: "When ON, every task is shown regardless of the visible limit. " +
            ...
            },
            {
                ...
                description: "Only applies when 'Show all tasks' is OFF. " +
            ...
            },
            {
                ...
                description: '"status" groups by completed → in-progress → pending. ' +
            ...
            },
            {
                ...
                description: '"bottom" hides tasks from the end of the list. ' +
        ...
        /* onChange */ (id, newValue) => {
            ...
            if (id === "sortOrder") {
                cfg.sortOrder = newValue;
                saveTasksConfig(cfg);
            }
            if (id === "hiddenAt") {
                cfg.hiddenAt = newValue;
                saveTasksConfig(cfg);
            }
        }, 
