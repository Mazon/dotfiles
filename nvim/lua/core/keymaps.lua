...
-- Move to window (split) using <leader> hlkj keys
--vim.keymap.set('n', '<leader>h', '<c-w>h', { desc = 'Split Left' })
--vim.keymap.set('n', '<leader>l', '<c-w>l', { desc = 'Split Right' })
--vim.keymap.set('n', '<leader>k', '<c-w>k', { desc = 'Split Up' })
--vim.keymap.set('n', '<leader>j', '<c-w>j', { desc = 'Split Down' })
...
vim.keymap.set('n', '<leader>b<left>', '<cmd>BufferLineMovePrev<cr>', { desc = 'Move Buffer to the left' })
vim.keymap.set('n', '<leader>b<right>', '<cmd>BufferLineMoveNext<cr>', { desc = 'Move Buffer to the right' })
