...
static const float bordercolor[]           = COLOR(0xfafafa00);
static const float focuscolor[]            = COLOR(0xde905f63);
...
static const char *const autostart[] = {
        "autostart.sh", "/home/mazon/.local/bin", NULL,
        NULL /* terminate */
};
...
static const char *mutevolume[]    = { "amixer",   " -D pulse sset Master 100%-",        NULL };
